...
list". It was decided to attribute a "weight" to numbers. The weight of a number will be from now on the sum of its digits.
...
function orderWeight(str) {
	return str.split(" ").sort((a, b) => sumOfParts(a) - sumOfParts(b) || a > b || -(a < b));
}
